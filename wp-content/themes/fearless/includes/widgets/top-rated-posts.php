...
function fearless_widget_top_rated_posts( $instance = array() ) {
	$args = array(
...
class fearless_top_rated_posts extends WP_Widget {

	function fearless_top_rated_posts() {
		parent::WP_Widget( false, $name = __( 'Fearless Top Rated Posts', 'fearless' ) );
	}
	...
	function widget( $args, $instance ) {
		...
		fearless_widget_top_rated_posts( $instance );
...
add_action( 'widgets_init', create_function( '', 'return register_widget( "fearless_top_rated_posts" );' ) );
