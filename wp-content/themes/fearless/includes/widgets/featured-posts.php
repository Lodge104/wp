...
function fearless_widget_featured_posts( $instance = array() ) {
	$args = array(
		'posts_per_page' => $instance['count'],
		'meta_key' => 'fearless_featured_post',
		'meta_value' => '1',
...
class fearless_featured_posts extends WP_Widget {

	function fearless_featured_posts() {
		parent::WP_Widget( false, $name = __( 'Fearless Featured Posts', 'fearless' ) );
	}
	...
	function widget( $args, $instance ) {
		...
		fearless_widget_featured_posts( $instance );
...
add_action( 'widgets_init', create_function( '', 'return register_widget( "fearless_featured_posts" );' ) );
