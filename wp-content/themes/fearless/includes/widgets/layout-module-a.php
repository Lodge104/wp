...
class fearless_layout_module_a extends WP_Widget {

	function fearless_layout_module_a() {
		parent::WP_Widget( false, $name = __( 'Fearless Layout Module A', 'fearless' ) );
	}

	function widget( $args, $instance ) {
		extract( $args );
		$title1 = apply_filters( 'widget_title', $instance['title1'], $instance['category1_id'] );
		$title2 = apply_filters( 'widget_title', $instance['title2'], $instance['category1_id'] );
...
add_action( 'widgets_init', create_function( '', 'return register_widget( "fearless_layout_module_a" );' ) );
