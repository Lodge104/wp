	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info">© <?php echo date("Y"); ?> Occoneechee Lodge | Site designed and managed by the <a href="https://github.com/Lodge104">Lodge Website Committee</a>   |   <a href="/privacy-policy/">Privacy Policy</a> and <a href="/terms-of-service/">Terms of Service</a></p>
