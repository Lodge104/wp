...
<body <?php if (is_home()) echo('id="home"');?> <?php body_class(); ?>>
	<div id="header">
		<div class="container">
				...
				<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
					<?php if (get_option('glow_swap_navbar') == 'false') { ?>
						<?php if (get_option('glow_home_link') == 'on') { ?>
							<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php bloginfo('url'); ?>"><?php esc_html_e('Home','Glow'); ?></a></li>
						<?php }; ?>
			...
			<!-- Logo -->
			<a href="<?php bloginfo('url'); ?>"><?php $logo = (get_option('glow_logo') <> '') ? get_option('glow_logo') : get_bloginfo('template_directory').'/images/logo.png'; ?>
				<img src="<?php echo esc_url( $logo ); ?>" alt="Logo" id="logo" class="unitPng"/></a>
