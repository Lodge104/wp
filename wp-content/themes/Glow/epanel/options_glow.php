...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		a:link, a:visited, .post a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		...
		#sidebar h3.sidebar-title { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		#sidebar h3.sidebar-title { background-color:#<?php echo(get_option($shortname.'_color_sidebar_bgtitles')); ?>; }
		a.comment-reply-link { color:#<?php echo(get_option($shortname.'_color_reply')); ?>; }
		.sidebar-block a, #sidebar div.custom-sidebar-block div.content a { color:#<?php echo(get_option($shortname.'_color_sidebar_link')); ?>; }
		.new-post h1 { color:#<?php echo(get_option($shortname.'_color_heading')); ?>; }
	</style>
